...
- Website direct-download links retired, single-app transition and authorization guides deployed at commit `e2c9209`, Cloudflare version `ba6c3553-ee52-4538-a728-168a1306e35f`. Historical GitHub releases are retained. Public availability remains pending.
...
- Submitted at 2026-09-22T16:08:00.25Z. Version 1.0 build 3 and review `224f26df-baf6-44f2-8935-635c6c44b852` are WAITING_FOR_REVIEW with AFTER_APPROVAL. New screenshot `0c7258b5-112e-4f33-b3d7-17a84448baef` is COMPLETE. The old build-2 review was cancelled and its old screenshots replaced. Exact state is in `release-evidence/store-only-release/final-submission-state.json`.
